...
public class UnlinkabilityTest extends BaseTest {
    ...
    @XrayTest(
            ...
            description = """
                        ...
                        A single credential offer may result in the issuance of multiple credentials sharing
                        the same credential dataset and format. While the dataset remains identical,
                        ...
                        correlation across batch issuance cycles and renewals.
                    """
    )
